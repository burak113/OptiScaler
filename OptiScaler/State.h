...
#include <inputs    an    ankerl::unordered_dense::map<void*, CapturedHudlessInfo> capturedHudlesses;
    bool clearCapturedHudlesses = false;
rdered_dense::map<void*, CapturedHudlessInfo> capturedH    bool WAR_xefgRequestFGToggle = false;
    ...
    bool clearCapturedHudlesses = false;
mline_Inputs_Sl1_Dx12.h>

#include <atomic>
#include    bool WAR_xefgRequestFGToggle = false;
